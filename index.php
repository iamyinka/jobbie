...
<div id="wrapper"> 
  ...
  <div class="banner-outer">
    ...
    <!-- <div id="banner" class="element"> <img src="http://deximlabs.com/dexjobs/light/assets/images/headerimage1.jpg" alt="banner"> </div> -->

    <div id="banner" class="element"> <img src="http://deximlabs.com/dexjobs/dark/assets/images/headerimage1.jpg" alt="banner"> </div>
    ...
    <div class="caption">
      ...
      <div class="holder">
        ...
        <div class="btn-row"> <a href="job-seekers.php"><i class="fa fa-user"></i>I’m a Jobseeker</a> <a href="employers.php"><i class="fa fa-building-o"></i>I’m an Employer</a> </div>
    ...
    <div class="browse-job-section">
      ...
      <div class="container">
        ...
        <div class="holder"> <a href="jobs.php" class="btn-brows">Browse Jobs</a> <strong class="title">Finds Jobs in San Francisco, Palo Alto, Mountain View, Sacramento, New York, United Kingdom, Asia Pacific</strong> </div>
              ...
              <div class="sidebar">
                ...
                <div class="box">
                  ...
                  <div class="thumb"> <a href="#"><img src="images/features-img-1.jpg" alt="img"></a>
                    ...
                    <div class="caption" style="color: #fff; font-size: 2.5em; text-align: center;">Microsoft</div>
